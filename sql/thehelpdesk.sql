...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 25, 2022 at 04:32 AM
...
(1, '01', 'โปรแกรมเมอร์', 'Programmer', 1),
(2, '02', 'ไอทีซัพพอต', 'IT Support', 1),
(3, '03', 'พนักงานขับรถ', 'Driver', 2),
(4, '007', 'สายลับ', 'SPY', 3),
(5, '0077', 'สายลับ 2', 'SPY 2', 3);
...
INSERT INTO `category_repair` (`category_id`, `category_name`, `category_color`) VALUES
...
(131, 'ทดสอบเพิ่มข้อมูล', '#35C4FF'),
(133, 'งานสร้างชิ้นงาน', '#F84CFF'),
(135, 'ทดสอบการเพิ่ม', '#FF48C8');
...
(1, 'pafntcF5D8ZSuPqGPwMwcd6UFJNJyLDNxgOBvcKr0CJ', '2021-02-15 09:30:01');
...
INSERT INTO `provinces` (`id`, `code`, `name_th`, `name_en`, `token_id`) VALUES
(1, '01', 'ไอที', 'IT', 'pafntcF5D8ZSuPqGPwMwcd6UFJNJyLDNxgOBvcKr0CJ'),
(2, '02', 'จัดซื้อ', 'PUR', '-'),
(3, '03', 'ขนส่ง', 'TS', 'pafntcF5D8ZSuPqGPwMwcd6UFJNJyLDNxgOBvcKr0CJ'),
(4, '07', 'ราชการ', 'ราชการ', 'pafntcF5D8ZSuPqGPwMwcd6UFJNJyLDNxgOBvcKr0CJ');
...
INSERT INTO `repair` (`repair_id`, `repair_code`, `employee_id`, `technician_id`, `product_id`, `repair_detail`, `repair_cause`, `category_id`, `image_name`, `status_id`, `repair_date`, `uploadfiles`) VALUES
(1, '2203-24-0000', 1038, 1038, 0, 'ทดสอบแจ้งซ่อม', '', 3, '', 0, '2022-03-24 07:50:06', 'ไม่มีไฟล์แนบ'),
(2, '2203-24-0001', 1002, 1037, 0, 'สายแลนไม่สามารถใช้งานได้', 'เปลี่ยนสายแลนใหม่', 1, '', 1, '2022-03-24 07:48:56', 'ไม่มีไฟล์แนบ'),
(3, '2203-24-0002', 1038, 0, 0, 'คอมพิวเตอร์มีฝุ่นเยอะ', 'ทำการเป่าฝุ่นและส่งมอบ', 3, '', 0, '2022-03-24 07:50:08', 'ไม่มีไฟล์แนบ'),
(4, '2203-24-0003', 1038, 0, 0, 'จอไม่ติด ทำงานไม่ได้เลยครับ', 'เปลี่ยนจอให้ใช้แทนระหว่างส่งเคลม', 1, '', 2, '2022-03-25 02:59:39', 'ไม่มีไฟล์แนบ'),
(5, '2203-24-0004', 1002, 0, 0, 'ทดสอบเพิ่มไฟล์', '', 1, '', 0, '2022-03-24 07:47:51', 'ไม่มีไฟล์แนบ'),
(6, '2203-25-0005', 999, 1037, 0, 'ทดสอบบันทึกเวลา', 'ทดสอบ', 1, '', 2, '2022-03-25 03:05:45', 'ไม่มีไฟล์แนบ'),
(8, '2203-25-0006', 999, 0, 0, 'ทดสอบบันทึกเวลาเปิดงาน', 'ทดสอบ', 133, '', 2, '2022-03-25 03:12:57', 'ไม่มีไฟล์แนบ'),
(9, '2203-25-0008', 999, 1037, 0, 'ทดสอบตารางเวลา', 'ทดสอบ', 1, '', 2, '2022-03-25 03:24:39', 'ไม่มีไฟล์แนบ');
...
INSERT INTO `repair_time` (`time_id`, `repair_id`, `status_id`, `time_date`) VALUES
(1, 4, 1, '2022-03-25 02:42:34'),
(2, 4, 2, '2022-03-25 02:59:39'),
(3, 6, 0, '2022-03-25 03:05:21'),
(4, 6, 1, '2022-03-25 03:05:36'),
(5, 6, 2, '2022-03-25 03:05:45'),
(7, 8, 0, '2022-03-25 03:07:25'),
(8, 8, 1, '2022-03-25 03:07:42'),
(9, 8, 2, '2022-03-25 03:07:55'),
(13, 9, 0, '2022-03-25 03:23:20'),
(14, 9, 0, '2022-03-25 03:23:31'),
(15, 9, 0, '2022-03-25 03:24:17'),
(16, 9, 1, '2022-03-25 03:24:30'),
(17, 9, 2, '2022-03-25 03:24:39');
...
CREATE TABLE `tblusers` (
  ...
  `uploadpic` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `line_token` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `tblusers` (`id`, `fullname`, `username`, `useremail`, `provinces_id`, `amphures_id`, `districts_id`, `role_id`, `password`, `uploadpic`, `line_token`, `regdate`) VALUES
(0, 'ยังไม่มีช่างซ่อม', '-', '-', '1', '1', '0', 0, 'e10adc3949ba59abbe56e057f20f883e', '005.jpg', 'Token 2', '2022-03-24 06:37:15'),
(999, 'admin', 'admin', 'admin@localhost.com', '1', '1', '260307', 999, 'e10adc3949ba59abbe56e057f20f883e', 'S__14336002.jpg', 'pafntcF5D8ZSuPqGPwMwcd6UFJNJyLDNxgOBvcKr0CJ', '2022-02-02 02:35:30'),
(1002, 'testusers', 'test', 'testtest@gmail.com', '1', '2', '140101', 0, 'e10adc3949ba59abbe56e057f20f883e', '-', 'pafntcF5D8ZSuPqGPwMwcd6UFJNJyLDNxgOBvcKr0CJ', '2022-02-02 03:03:46'),
(1037, 'ทดสอบ ดีใจ', 'nopartza', 'todsob1@local', '3', '1', '0', 2, 'e10adc3949ba59abbe56e057f20f883e', '-', 'pafntcF5D8ZSuPqGPwMwcd6UFJNJyLDNxgOBvcKr0CJ', '2022-03-24 06:48:01'),
(1038, 'สวัสดี คนไทย', 'nopartz', 'todsob2@local', '2', '3', '0', 2, 'e10adc3949ba59abbe56e057f20f883e', '-', 'Token 5', '2022-03-24 06:31:42'),
(1048, 'แอดมิน ทดสอบ', 'admin_nop', 'todsob3@local', '1', '1', '0', 999, 'e10adc3949ba59abbe56e057f20f883e', 'S__14336002.jpg', 'Token 1', '2022-02-02 03:14:09'),
(1050, 'ธงชัย ใจบ้านเกิด', 'thongchai', 'tch_1@gmail.com', '3', '4', '0', 0, 'e10adc3949ba59abbe56e057f20f883e', '6a709d1cc77d3ecc059323c8aa2a9b2a.jpg', '', '2022-03-24 08:17:31');
...
--
ALTER TABLE `category_repair`
  MODIFY `category_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=136;
...
--
ALTER TABLE `repair`
  MODIFY `repair_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
